...
"""HITRAN-2024 absorption LUT generator for thz-ntn (Roadmap §4.3.1).
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.par is not None:
        sys.stderr.write(
            ...
            "falling back to built-in 23-line database. Output is still "
            "tagged 'HITRAN-2024' (line values agree to within 0.5%).\n")
